...
#ifndef OS_CPU_BSD_ARM_VM_PREFETCH_BSD_ARM_INLINE_HPP
#define OS_CPU_BSD_ARM_VM_PREFETCH_BSD_ARM_INLINE_HPP
...
#endif // OS_CPU_BSD_ARM_VM_PREFETCH_BSD_ARM_INLINE_HPP
