...
#ifndef OS_CPU_BSD_ARM_VM_ATOMIC_BSD_ARM_HPP
#define OS_CPU_BSD_ARM_VM_ATOMIC_BSD_ARM_HPP
 ...
 * under current Bsd distros these instructions appear atomic.
 ...
 * Bsd kernel using _kuser_helper_version. See entry-armv.S in the Bsd
 * kernel source or kernel_user_helpers.txt in Bsd Doc.
 */
...
#endif // OS_CPU_BSD_ARM_VM_ATOMIC_BSD_ARM_HPP
